...
\hlstd{churn.kstest} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{feature}\hlstd{) \{}
  ...
  \hlkwd{c}\hlstd{(feature,} \hlkwd{ks.test}\hlstd{(yes[[feature]], no[[feature]])[}\hlkwd{c}\hlstd{(}\hlstr{"statistic"}\hlstd{,} \hlstr{"p.value"}\hlstd{)])}
\hlstd{\}}

\hlkwd{lapply}\hlstd{(}\hlkwd{colnames}\hlstd{(}\hlkwd{subset}\hlstd{(numerics,} \hlkwc{select}\hlstd{=}\hlopt{-}\hlstd{Churn.)), churn.kstest)}
\end{alltt}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in ks.test(yes[[feature]], no[[feature]]): p-value will be approximate in the presence of ties}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in ks.test(yes[[feature]], no[[feature]]): p-value will be approximate in the presence of ties}}\begin{verbatim}
## [[1]]
## [[1]][[1]]
## [1] "Account.Length"
## 
