...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: <text>:4:0: unexpected end of input\\\#\# 2: library(xtable)\\\#\# 3: opts\_chunk\$set(fig.path='figure/', fighelp(.align='center', fig.pos='H',fig.width=5, fig.height=4)\\\#\#\ \  \textasciicircum{}}}\end{kframe}
\end{knitrout}
...
\hlstd{df}\hlopt{$}\hlstd{Churn.} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(df}\hlopt{$}\hlstd{Churn.)}
\hlstd{df}\hlopt{$}\hlstd{Int.l.Plan} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(df}\hlopt{$}\hlstd{Int.l.Plan)}
\hlstd{df}\hlopt{$}\hlstd{VMail.Plan} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(df}\hlopt{$}\hlstd{VMail.Plan)}
\hlstd{df}\hlopt{$}\hlstd{State} \hlkwb{<-} \hlkwd{as.factor}\hlstd{(df}\hlopt{$}\hlstd{State)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/Pair_plot_for_continuous_variables_grouped-1} 
\begin{kframe}\begin{alltt}
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/Pair_plot_for_continuous_variables_grouped-2} 
