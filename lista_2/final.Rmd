...
W pierwszym zadaniu mamy zbadać
```{r}
data(iris)
```
...
Teraz naszym zadaniem jest \ldots
...
summary.matrix %>% kbl(caption="Odchylenie standardowe i wspolczynnik zmiennosci dla zmienych", format="latex") %>% kable_styling(latex_options=c('hold_position', 'scale_down'))
```
