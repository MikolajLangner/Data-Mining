...
Błędy wyniosły kolejno `r knn.error.cv$error` i `r knn.error.boot$error`.
...
Błędy wyniosły kolejno `r decision.tree.error.cv$error` i `r decision.tree.error.boot$error`.
...
Błędy predykcji wyniosły kolejno `r naiveBayes.error.cv$error` i `r naiveBayes.error.boot$error`. 
...
Błędy predykcji wyniosły `r mlr.error.cv$error` i `r mlr.error.boot$error`. 
