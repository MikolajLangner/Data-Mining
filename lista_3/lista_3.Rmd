...
```{r data boxplot, echo=FALSE, eval=TRUE, fig.caption="Wykresy pudelkowe dla naszch danych."}
...
train.subset <- train.data[, c(3, 6, 10)]
test.subset <- test.data[, c(3, 6, 10)]
```
...
```{r}
basic.tree.model <- rpart(Class ~ ., data = train.data)
