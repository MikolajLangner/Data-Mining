...
```{r clusters pam, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8}
data(wine)
...
```{r clusters agnes single, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8}
data(wine)
...
```{r clusters agnes complete, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8}
data(wine)
