...
```{r clusters pam, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Skupienia dla metody PAM"}
data(wine)
...
```{r clusters agnes single, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Skupienia dla metody AGNES z single-linkage"}
data(wine)
...
```{r clusters agnes complete, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Skupienia dla metody AGNES z complete-linkage"}
data(wine)
...
W tej części zadania, porównamy ze sobą algorytmy, jakość uzyskanego dzięk nim grupowania w zależności od przyjętej ilości skupień. Wykorzystamy wskźniki wewnętrzne, jak i zewnętrzne.
